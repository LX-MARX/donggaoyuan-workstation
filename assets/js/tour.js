...
(function () {
  ...
  var STEPS = [
    ...
    {
      t: "政策智库：像逛超市一样查政策",
      d: "进「政策智库」，先点标签（级别、领域、年份、机关、主题），再输关键词，121 条政策秒级过滤；每条政策直接列出级别、文号与基层落实要点，点卡片上的主题小标签还能按主题一键筛选。"
    },
    {
      t: "申报助手：4 个条件找出能报的项目",
      d: "进「申报助手」，选好申报主体、村庄特征、需求领域、资金规模，系统从 62 个真实项目里筛出你能报的，给出材料清单与申报流程；驻村调研预约在「预约调研」页提交，可生成登记凭证。"
    },
    {
      t: "数据看板：全县运营一屏掌握",
